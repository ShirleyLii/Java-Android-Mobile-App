...
public class WarriorActivity extends FragmentActivity implements RatingBar.OnRatingBarChangeListener{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.warriorrating);
...
//        points = points - strength - intelligence - wisdom - dexterity;
    ...
    public void onRatingChanged(RatingBar bar, float rating, boolean fromUser){
        ...
        if (bar.toString().contains("Strength") && (rating > strength)){
            ...
            //Update SavedPreference
            editor.putFloat("Strength", rating);
            editor.commit();
